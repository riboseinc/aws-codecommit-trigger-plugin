...
image:https://ci.jenkins.io/buildStatus/icon?job=Plugins/aws-codecommit-trigger-plugin/master&style=flat-square[link=https://ci.jenkins.io/job/Plugins/job/aws-codecommit-trigger-plugin/job/master/]
