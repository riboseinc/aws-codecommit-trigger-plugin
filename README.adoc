...
image:https://img.shields.io/travis/riboseinc/aws-codecommit-trigger-plugin.svg?style=flat-square[link=https://travis-ci.org/riboseinc/aws-codecommit-trigger-plugin]
