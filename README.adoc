...
[link=https://travis-ci.org/riboseinc/aws-codecommit-trigger-plugin]
image::http://img.shields.io/travis/riboseinc/aws-codecommit-trigger-plugin.svg?style=flat-square[Build Status]
[link=http://www.apache.org/licenses/LICENSE-2.0.html]
image::http://img.shields.io/:license-apache-blue.svg?style=flat-square[License]
...
image::doc/images/plugin-queue-configuration-success.png["Jenkins configuration test"]
...
image::doc/images/jenkins-build-triggers.png[Build trigger configuration]
