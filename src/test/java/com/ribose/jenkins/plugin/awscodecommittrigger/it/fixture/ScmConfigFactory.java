...
public class ScmConfigFactory {
    ...
    public List<SQSScmConfig> createIR() {
        return Collections.singletonList(new SQSScmConfig(SQSScmConfig.Type.AutoSubscription.name(), null, null));
    }
    ...
    public List<SQSScmConfig> createERs(String... args) {
        ...
        for (int i = 0; i < args.length; i += 2) {
            ...
            scms.add(new SQSScmConfig(SQSScmConfig.Type.ManualSubscription.name(), url, subscribedBranches));
        }
